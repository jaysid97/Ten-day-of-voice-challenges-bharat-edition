...
- [x] **Agent Code Updated**: `backend/src/agent.py` updated with structured prompt & greeting.
- [x] **Red-Teaming Log**: `RED_TEAM.md` committed with 10 test prompts.
- [x] **Automated Evals**: `backend/tests/test_day2_guardrails.py` created for pytest.
- [ ] **Record 45s Video**: Showing Greeting -> Hinglish Mix -> Guardrail Escalation.
- [ ] **Post on LinkedIn**: Use the `#VoiceForBharat` hashtag & tag **Murf AI**.
- [ ] **Submit Form**: Fill the Discord submission link with your LinkedIn post URL.
